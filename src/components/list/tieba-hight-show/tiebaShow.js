...
import {RequestHightTieba,sendChooseTiebaItem} from "@/axios/index"
const columns = [
  {
    title: 'Name',
    dataIndex: 'name',
...
const WXTiebaHightShow = () => {
  ...
  const sendNewData=()=>{
    sendChooseTiebaItem(selectedRowKeys,page_num).then((value)=>{
        var firstData=value.data;
...
export default WXTiebaHightShow;